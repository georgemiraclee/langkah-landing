...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="relative overflow-hidden bg-[#81B6BE] pt-[120px] md:pt-[130px] lg:pt-[160px]"
      >
            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                  Langkah Kembang Anak
                </h1>
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                 Langkah adalah aplikasi deteksi dan pemantauan tumbuh kembang secara fisik dan psikologis yang dapat digunakan mudah oleh orang tua
                </p>
